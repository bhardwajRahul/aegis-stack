...
make test-template-database      # Test database component specifically
...
vim aegis/templates/copier-aegis-project/{{ project_slug }}/app/...
...
- **Template syntax errors** -> Check Jinja2 syntax in `.jinja` files
