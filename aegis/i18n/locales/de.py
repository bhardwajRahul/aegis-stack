...
MESSAGES: dict[str, str] = {
    ...
    "deploy.disk_low": "Nur {free}GB frei auf {host}, benötigt werden {need}GB. Aufräumen mit: docker image prune -af && docker builder prune -af",
    "deploy.pruning": "Docker-Speicher wird freigegeben (verwaiste Images und alter Build-Cache)...",
    "deploy.prune_failed": "Docker-Speicher konnte nicht freigegeben werden; das Deployment selbst war erfolgreich.",
    ...
    "plugins.no_external_installed": "Keine externen Plugins installiert. Installation per: pip install aegis-stack-<name>",
    ...
    "plugins.update_not_pip_installed": "Plugin '{name}' steht in der _plugins-Liste des Projekts, ist aber aktuell nicht per pip installiert; bitte zuerst `pip install {dist}` ausführen.",
    ...
    "plugins.help_create": "Ein neues aegis-stack-<name>-Python-Paket gerüstet erzeugen.",
    "plugins.help_arg_create_name": "Plugin-Name (Kleinbuchstaben, keine Bindestriche). Wird zum Python-Paketnamen aegis_stack_<name> und zum Installationsnamen aegis-stack-<name>.",
    ...
    "plugins.create_next_steps_edit_comment": "src/aegis_stack_<name>/plugin.py bearbeiten, um die Verdrahtung zu ergänzen",
    ...
    "plugins.search_install_hint": "Vorerst: pip install aegis-stack-<name>, dann aegis plugins list.",
