...
MESSAGES: dict[str, str] = {
    ...
    "add_service.experimental_warning": "{service} is experimental: its schema, APIs and CLI surface may change between releases.",
    ...
    "deploy.disk_low": "Solo quedan {free}GB libres en {host}, se necesitan {need}GB. Libera espacio con: docker image prune -af && docker builder prune -af",
    "deploy.pruning": "Liberando disco de Docker (imágenes huérfanas y caché de compilación antigua)...",
    "deploy.prune_failed": "No se pudo liberar el disco de Docker; el despliegue sí se completó.",
    ...
    "plugins.no_external_installed": "No hay plugins externos instalados. Instala uno con: pip install aegis-stack-<name>",
    ...
    "plugins.update_not_pip_installed": "El plugin '{name}' figura en la lista _plugins del proyecto, pero no está instalado vía pip; ejecuta primero `pip install {dist}`.",
    ...
    "plugins.help_create": "Generar el andamiaje de un nuevo paquete Python aegis-stack-<name>.",
    "plugins.help_arg_create_name": "Nombre del plugin (minúsculas, sin guiones). Se convertirá en el paquete Python aegis_stack_<name> y en el nombre de instalación aegis-stack-<name>.",
    ...
    "plugins.create_next_steps_edit_comment": "edita src/aegis_stack_<name>/plugin.py para añadir el cableado",
    ...
    "plugins.search_install_hint": "Por ahora: pip install aegis-stack-<name>, luego aegis plugins list.",
    ...
    "build.step.revisions": "Derivando revisiones desde los modelos",
